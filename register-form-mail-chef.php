<?php
/*
Template Name: chef_新規登録フォーム_メール認証
*/
?>
<?php get_header(); ?>
<div class="p-form__area">
    <div class="is-step1">
        <div class="p-form__title" id="btn"><span>メールアドレス入力</span></div>
    ...
    <div class="is-step2">
        <div class="p-form__title" id="btn"><span>メールアドレス認証</span></div>
            <div class="p-flow__area">
                <div class="p-flow__wrap"><div class="p-flow__parts">メールアドレス入力</div></div>
                <div class="p-flow__wrap is-active"><div class="p-flow__parts">メールアドレス認証</div></div>
                <div class="p-flow__wrap"><div class="p-flow__parts">基本情報入力</div></div>
                <div class="p-flow__wrap"><div class="p-flow__parts">プロフィール入力</div></div>
                <div class="p-flow__wrap"><div class="p-flow__parts">登録完了</div></div>
            </div>
